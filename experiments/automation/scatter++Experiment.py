            ...
            "microservices": [
                {
                    ...
                    "cmd": ["/bin/bash", "-c",
                            "/home/src/build/server primary >> output.txt 2>&1 & /home/SidecarQueue -entry=true -exit=false -p=50101 -next=10.30.102.1:50102 -sidecar=localhost:5000 -analytics=1 -ms=100 >> output.txt 2>&1 & tail -f output.txt"],
                ...
                },
                {
                    ...
                    "virtualization": "container",
                    "cmd": ["/bin/bash", "-c",
                            "/home/src/build/server sift >> output.txt 2>&1 & /home/SidecarQueue -entry=false -exit=false -p=50102 -next=10.30.103.1:50103 -sidecar=localhost:5000 -analytics=1 -parallel=2 -ms=100 -qsize=5 >> output.txt 2>&1 & tail -f output.txt"],
                    "health-check": ["/bin/bash", "-c", "sleep 5"],
                    "memory": 1000,
                    "vcpus": 1,
                    "vgpus": 1,
                ...
                },
                {
                    ...
                    "virtualization": "container",
                    "cmd": ["/bin/bash", "-c",
                            "/home/src/build/server encoding >> output.txt 2>&1 & /home/SidecarQueue -entry=false -exit=false -p=50103 -next=10.30.104.1:50104 -sidecar=localhost:5000 -analytics=1 -parallel=2 -ms=100 -qsize=5 >> output.txt & tail -f output.txt"],
                    "health-check": ["/bin/bash", "-c", "sleep 5"],
                    "memory": 1000,
                    "vcpus": 1,
                    "vgpus": 1,
                ...
                },
                {
                    ...
                    "virtualization": "container",
                    "cmd": ["/bin/bash", "-c",
                            "/home/src/build/server lsh >> output.txt 2>&1 & /home/SidecarQueue -entry=false -exit=false -p=50104 -next=10.30.105.1:50105 -sidecar=localhost:5000 -analytics=1 -parallel=2 -ms=100 -qsize=5 >> output.txt & tail -f output.txt"],
                    "health-check": ["/bin/bash", "-c", "sleep 5"],
                    "memory": 1000,
                    "vcpus": 1,
                    "vgpus": 1,
                ...
                },
                {
                    ...
                    "virtualization": "container",
                    "cmd": ["/bin/bash", "-c",
                            #"cd /home/lib/cudasift && rm CMakeCache.txt &&  sed -i 's/executable/library/g' CMakeLists.txt && cmake -D CUDA_TOOLKIT_ROOT_DIR=/usr/local/cuda-12.1 -G 'Unix Makefiles' -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS:STRING='-O0' . && make && cd /home/src/build &&  rm CMakeCache.txt && cmake -DCMAKE_CXX_FLAGS:STRING='-O0' .. && make && ./server matching >> output.txt & /home/SidecarQueue -entry=false -exit=true -p=50105 -sidecar=localhost:5000 -analytics=1 >> output.txt & tail -f output.txt"],
                            "/home/src/build/server matching >> output.txt 2>&1 & /home/SidecarQueue -entry=false -exit=true -p=50105 -sidecar=localhost:5000 -analytics=1 -ms=100 -qsize=5 >> output.txt & tail -f output.txt"],
                    "health-check": ["/bin/bash", "-c", "sleep 5"],
                    "memory": 1000,
                    "vcpus": 1,
                    "vgpus": 1,
